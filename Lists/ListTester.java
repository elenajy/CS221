...
public class ListTester {
	...
	private void runTests() {
		...
		Integer[] LIST_BCA = {ELEMENT_B,ELEMENT_C,ELEMENT_A};
		String STRING_BCA="BCA";
		...
		Integer[] LIST_DBC = {ELEMENT_C,ELEMENT_A,ELEMENT_B};
		String STRING_DBC="CAB";
		Integer[] LIST_ADC = {ELEMENT_C,ELEMENT_B,ELEMENT_A};
		String STRING_ADC="CBA";
		Integer[] LIST_ABD = {ELEMENT_C,ELEMENT_A,ELEMENT_B};
		String STRING_ABD="CAB";
		...
		testSingleElementList(emptyList_add0_A,"emptyList_add0_A",LIST_A,STRING_A);
	    ...
	    testSingleElementList(AB_iterator_remove_after2Next_A ,"AB_iterator_remove_after2Next_A ",LIST_A,STRING_A);
	    testTwoElementList(ABC_iterator_remove_afterNext_BC,"ABC_iterator_remove_afterNext_BC",LIST_BC,STRING_BC);
	    testTwoElementList(ABC_iterator_remove_after2Next_AC,"ABC_iterator_remove_after2Next_AC",LIST_AC,STRING_AC);
	    testTwoElementList(ABC_iterator_remove_after3Next_AB,"ABC_iterator_remove_after3Next_AB",LIST_AB,STRING_AB);
...
//			break;
	...
	private Scenario<Integer> emptyList_add0_A = () -> emptyList_add0_A();
    ...
    private Scenario<Integer> AB_iterator_remove_after2Next_A =  () -> AB_iterator_remove_after2Next_A();
    private Scenario<Integer> ABC_iterator_remove_afterNext_BC = () -> ABC_iterator_remove_afterNext_BC();
    private Scenario<Integer> ABC_iterator_remove_after2Next_AC = () -> ABC_iterator_remove_after2Next_AC();  
    private Scenario<Integer> ABC_iterator_remove_after3Next_AB =  () -> ABC_iterator_remove_after3Next_AB ();
    // (50-55)
	 ...
	 */
	private IndexedUnsortedList<Integer> emptyList_add0_A(){
		IndexedUnsortedList<Integer> list = newList(); 
	...
	/**Scenario: [A] -> A_add0B_BA() -> [B,A]
	 * @return [A,B] after A_add0B_BA()
	 */
	...
	private IndexedUnsortedList<Integer> AB_iterator_remove_after2Next_A(){		
		IndexedUnsortedList<Integer> list= A_addToRearB_AB();
		Iterator<Integer> itr = list.iterator();
		itr.next();
		itr.next();
	...
	private IndexedUnsortedList<Integer> ABC_iterator_remove_after2Next_AC(){		
		IndexedUnsortedList<Integer> list=AB_addToRearC_ABC();
		Iterator<Integer> itr = list.iterator();
		itr.next();
		itr.next();
	...
	private IndexedUnsortedList<Integer> ABC_iterator_remove_after3Next_AB(){		
		IndexedUnsortedList<Integer> list=AB_addToRearC_ABC();
		Iterator<Integer> itr = list.iterator();
		itr.next();
		itr.next();
	...
	private void test_ListIterConcurrency() {
		...
		try {
			...
			it2 = list.listIterator();
			it1.hasNext();
			printTest("emptyList_ListIter1HasNext_testListIter2AddA", testlistiterator_add_(it2, ELEMENT_A, Result.NoException));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.hasNext();
			printTest("emptyList_ListIter1HasNext_testListIter2SetA", testlistiterator_set_(it2, ELEMENT_A, Result.IllegalState));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.hasNext();
			...
			it2 = list.listIterator();
			it1.hasPrevious();
			printTest("emptyList_ListIter1HasPrevious_testListIter2AddA", testlistiterator_add_(it2, ELEMENT_A, Result.NoException));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.hasPrevious();
			printTest("emptyList_ListIter1HasPrevious_testListIter2SetA", testlistiterator_set_(it2, ELEMENT_A, Result.IllegalState));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.hasPrevious();
			...
			it2 = list.listIterator();
			it1.nextIndex();
			printTest("emptyList_ListIter1NextIndex_testListIter2AddA", testlistiterator_add_(it2, ELEMENT_A, Result.NoException));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.nextIndex();
			printTest("emptyList_ListIter1NextIndex_testListIter2SetA", testlistiterator_set_(it2, ELEMENT_A, Result.IllegalState));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.nextIndex();
			...
			it2 = list.listIterator();
			it1.previousIndex();
			printTest("emptyList_ListIter1PreviousIndex_testListIter2AddA", testlistiterator_add_(it2, ELEMENT_A, Result.NoException));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.previousIndex();
			printTest("emptyList_ListIter1PreviousIndex_testListIter2SetA", testlistiterator_set_(it2, ELEMENT_A, Result.IllegalState));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.previousIndex();
			...
			it2 = list.listIterator();
			it1.add(ELEMENT_A);
			printTest("emptyList_ListIter1AddA_testListIter2AddB", testlistiterator_add_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.add(ELEMENT_A);
			printTest("emptyList_ListIter1AddA_testListIter2SetA", testlistiterator_set_(it2, ELEMENT_A, Result.ConcurrentModification));
			list = newList();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.add(ELEMENT_A);
			...
			it2 = list.listIterator();
			it1.next();
			printTest("A_ListIter1Next_testListIter2AddB", testlistiterator_add_(it2, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.next();
			printTest("A_ListIter1Next_testListIter2SetB", testlistiterator_set_(it2, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.next();
			...
			it1 = list.listIterator(1);
			it1.previous();
			printTest("A_ListIter1Previous_testListIter2AddB", testlistiterator_add_(it2, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it2 = list.listIterator();
			it1 = list.listIterator(1);
			it1.previous();
			printTest("A_ListIter1Previous_testListIter2SetB", testlistiterator_set_(it2, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it2 = list.listIterator();
			it1 = list.listIterator(1);
			it1.previous();
			...
			it1.next();
			it1.remove();
			printTest("A_ListIter1NextRemove_testListIter2AddB", testlistiterator_add_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.next();
			it1.remove();
			printTest("A_ListIter1NextRemove_testListIter2SetB", testlistiterator_set_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.next();
			...
			it1.previous();
			it1.remove();
			printTest("A_ListIter1PreviousRemove_testListIter2AddB", testlistiterator_add_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it2 = list.listIterator();
			it1 = list.listIterator(1);
			it1.previous();
			it1.remove();
			printTest("A_ListIter1PreviousRemove_testListIter2SetB", testlistiterator_set_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it2 = list.listIterator();
			it1 = list.listIterator(1);
			it1.previous();
			...
			it1.next();
			it1.set(ELEMENT_B);
			printTest("A_ListIter1NextSetB_testListIter2AddB", testlistiterator_add_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.next();
			it1.set(ELEMENT_B);
			printTest("A_ListIter1NextSetB_testListIter2SetB", testlistiterator_set_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			it2 = list.listIterator();
			it1.next();
			...
			it1.previous();
			it1.set(ELEMENT_B);
			printTest("A_ListIter1PreviousSetB_testListIter2AddB", testlistiterator_add_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it2 = list.listIterator();
			it1 = list.listIterator(1);
			it1.previous();
			it1.set(ELEMENT_B);
			printTest("A_ListIter1PreviousSetB_testListIter2SetB", testlistiterator_set_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it2 = list.listIterator();
			it1 = list.listIterator(1);
			it1.previous();
			...
			it1 = list.listIterator(1);
			it1.add(ELEMENT_B);
			printTest("A_ListIter11AddB_testListIter2AddB", testlistiterator_add_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it2 = list.listIterator();
			it1 = list.listIterator(1);
			it1.add(ELEMENT_B);
			printTest("A_ListIter11AddB_testListIter2SetB", testlistiterator_set_(it2, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it2 = list.listIterator();
			it1 = list.listIterator(1);
			it1.add(ELEMENT_B);
			...
			it1 = list.listIterator();
			list.removeFirst();
			printTest("A_removeFirst_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.removeFirst();
			printTest("A_removeFirst_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.removeFirst();
			...
			it1 = list.listIterator();
			list.removeLast();
			printTest("A_removeLast_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.removeLast();
			printTest("A_removeLast_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.removeLast();
			...
			it1 = list.listIterator();
			list.remove(ELEMENT_A);
			printTest("A_removeA_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.remove(ELEMENT_A);
			printTest("A_removeA_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.remove(ELEMENT_A);
			...
			it1 = list.listIterator();
			list.first();
			printTest("A_first_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.first();
			printTest("A_first_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.first();
			...
			it1 = list.listIterator();
			list.last();
			printTest("A_last_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.last();
			printTest("A_last_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.last();
			...
			it1 = list.listIterator();
			list.contains(ELEMENT_A);
			printTest("A_containsA_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.contains(ELEMENT_A);
			printTest("A_containsA_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.contains(ELEMENT_A);
			...
			it1 = list.listIterator();
			list.isEmpty();
			printTest("A_isEmpty_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.isEmpty();
			printTest("A_isEmpty_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.isEmpty();
			...
			it1 = list.listIterator();
			list.size();
			printTest("A_size_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.size();
			printTest("A_size_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.size();
			...
			it1 = list.listIterator();
			list.toString();
			printTest("A_toString_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.toString();
			printTest("A_toString_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.toString();
			...
			it1 = list.listIterator();
			list.addToFront(ELEMENT_B);
			printTest("A_addToFrontB_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.addToFront(ELEMENT_B);
			printTest("A_addToFrontB_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.addToFront(ELEMENT_B);
			...
			it1 = list.listIterator();
			list.addToRear(ELEMENT_B);
			printTest("A_addToRearB_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.addToRear(ELEMENT_B);
			printTest("A_addToRearB_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.addToRear(ELEMENT_B);
			...
			it1 = list.listIterator();
			list.addAfter(ELEMENT_B, ELEMENT_A);
			printTest("A_addAfterAB_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.addAfter(ELEMENT_B, ELEMENT_A);
			printTest("A_addAfterAB_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.addAfter(ELEMENT_B, ELEMENT_A);
			...
			it1 = list.listIterator();
			list.add(0, ELEMENT_B);
			printTest("A_add0B_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.add(0, ELEMENT_B);
			printTest("A_add0B_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.add(0, ELEMENT_B);
			...
			it1 = list.listIterator();
			list.set(0, ELEMENT_B);
			printTest("A_set0B_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.set(0, ELEMENT_B);
			printTest("A_set0B_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.set(0, ELEMENT_B);
			...
			it1 = list.listIterator();
			list.add(ELEMENT_B);
			printTest("A_addB_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.add(ELEMENT_B);
			printTest("A_addB_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.add(ELEMENT_B);
			...
			it1 = list.listIterator();
			list.get(0);
			printTest("A_get0_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.get(0);
			printTest("A_get0_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.get(0);
			...
			it1 = list.listIterator();
			list.indexOf(ELEMENT_A);
			printTest("A_indexOfA_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.NoException));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.indexOf(ELEMENT_A);
			printTest("A_indexOfA_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.IllegalState));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.indexOf(ELEMENT_A);
			...
			it1 = list.listIterator();
			list.remove(0);
			printTest("A_remove0_testlistiterator_add_BConcurrent", testlistiterator_add_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.remove(0);
			printTest("A_remove0_testlistiterator_set_BConcurrent", testlistiterator_set_(it1, ELEMENT_B, Result.ConcurrentModification));
			list = emptyList_addToFrontA_A();
			it1 = list.listIterator();
			list.remove(0);
